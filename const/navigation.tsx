...
export interface Navigation<T extends Page[]> {
  [key: string]: T;
}
...
// Type guard to check if the page object has the `icon` property
export const hasIcon = (item: Page | PageWithIcon): item is PageWithIcon => {
  return 'icon' in item;
};

// Wrapper component for rendering icon function
export const IconWrapper = ({ icon }: { icon: PageWithIcon['icon'] }) => {
